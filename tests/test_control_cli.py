...
class TestManuscript:
    """The verb's conventions only — authored drafts are exercised in
    test_publication_manuscript.py, which has a lab to author with."""
    ...
    def test_a_walk_without_a_research_state_is_refused(
        ...
        code = main(["manuscript", "--root", str(tmp_path)])
    ...
    def test_a_missing_root_is_named(
        ...
        code = main(["manuscript", "--root", str(tmp_path / "nowhere")])
...
class TestReview:
    """The verb's conventions only — reviewed drafts are exercised in
    test_publication_review.py, which has a lab to review with."""
    ...
    def test_a_walk_without_a_research_state_is_refused(
        ...
        code = main(["review", "--root", str(tmp_path)])
    ...
    def test_a_missing_root_is_named(
        ...
        code = main(["review", "--root", str(tmp_path / "nowhere")])
...
class TestRender:
    """The verb's conventions only — rendered submissions are exercised
    in test_publication_latex.py, which has an approved draft to render."""
    ...
    def test_a_walk_without_a_research_state_is_refused(
        ...
        code = main(["render", "--root", str(tmp_path), "--venue", "plain"])
    ...
    def test_a_missing_root_is_named(
        ...
        code = main(
            ["render", "--root", str(tmp_path / "nowhere"), "--venue", "plain"]
        )
...
class TestFigures:
    """The verb's conventions only — the store, the packet mirrors,
    and the renderer are exercised in test_publication_figures*.py."""
    ...
    def test_a_walk_without_a_research_state_is_refused(
        ...
        code = main(["figures", "--root", str(tmp_path)])
    ...
    def test_a_missing_root_is_named(
        ...
        code = main(["figures", "--root", str(tmp_path / "nowhere")])
